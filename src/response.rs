...
mod tests {
    ...
    /// A body captured from `POST /v1/responses`
    /// with model `gateway/gpt-5.6-sol` on 2026-08-30, `stream` absent.
    ...
    fn a_captured_buffered_body_decodes() {
        ...
        assert_eq!(response.model.as_deref(), Some("gateway/gpt-5.6-sol"));
